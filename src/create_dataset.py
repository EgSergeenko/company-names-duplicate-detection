...
NON_NFKD_MAP = types.MappingProxyType({
    '\u0181': 'B', '\u1d81': 'd', '\u1d85': 'l',
    '\u1d89': 'r', '\u028b': 'v', '\u019d': 'N',
    '\u1d8d': 'x', '\u1d83': 'g', '\u0191': 'F',
    '\u0220': 'N', '\u01a5': 'p', '\u0224': 'Z',
...
TERMS_BY_TYPE = types.MappingProxyType({
    'Corporation': [
...
TERMS_BY_COUNTRY = types.MappingProxyType({
    'Albania': ['sh.a.', 'sh.p.k.'],
    'Argentina': [
    ...
    'Denmark': [
        'i/s', 'a/s', 'k/s', 'p/s', 'amba',
        's.m.b.a.', 'g/s', 'a.m.b.a.', 'fmba', 'f.m.b.a.', 'smba',
    ],
    'Dominican Republic': [
        'c. por a.', 'cxa', 's.a.', 's.a.s.',
        'sas', 'srl.', 'srl', 'eirl.', 'sa',
    ],
    ...
    'Germany': [
        'gmbh & co. kg', 'e.g.', 'e.v.', 'gbr', 'ohg', 'partg',
        'kgaa', 'gmbh', 'g.m.b.h.', 'ag', 'mbh & co. kg',
    ],
    'Greece': [
        'a.e.', 'ae', 'e.e.', 'ee', 'epe', 'e.p.e.', 'mepe',
...
def delete_extra(
    ...
    """Remove extra characters and checking for the correctness of the name.
...
def get_key(
    ...
    """Get a key in a dictionary by value.
